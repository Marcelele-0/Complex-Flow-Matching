...
from cfm.data.stft import StftProtocol, forward_stft, segment_frames  # noqa: E402
...
def create_frames(store: h5py.File, protocol: StftProtocol) -> h5py.Dataset:
    ...
    One chunk is one segment, which is how :class:`~cfm.data.stft_store.StftStoreDataset`
...
def write_attrs(
    ...
    store.attrs["dropped_bin"] = "nyquist; negligible energy in speech, see cfm.data.stft"
