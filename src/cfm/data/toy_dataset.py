...
are related. Both draw their coefficients through :class:`~cfm.data.synthetic.CylinderToy`,
...
should do no better than :class:`~cfm.models.pointwise_mlp.PointwiseVelocityMLP`.
...
:class:`~cfm.core.dataset.BaseComplexDataset` interface that the entry points use
...
from cfm.data.synthetic import CylinderToy
...
class CylinderToyFieldDataset(_CylinderToyDataset):
    ...
    :func:`~cfm.data.build_dataset` resolves config keys by inspecting the
