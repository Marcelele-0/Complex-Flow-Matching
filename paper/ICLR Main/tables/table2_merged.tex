\begin{table}[h]
    ...
    the arms of its block, which is what stops the comparison from being an artefact of
    the two converging to different asymptotes. It is the median over seeds, and it is
    read off a denser step grid than the columns shown. Errors are comparable within a block and
