...
\begin{itemize}
    ...
    \item \textbf{Few-step generation.} At $16\times16$, $32\times32$ and $64\times64$, CyFM with the joint coupling reaches a lower error than the best Cartesian baseline at every $k \le 8$ integration steps, with all five seeds separated and no distillation. Run to convergence, we detect no significant difference between them.
