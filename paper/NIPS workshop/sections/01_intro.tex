...
This magnitude-only paradigm creates a research gap, as emerging complex-valued networks demonstrate superior signal fidelity in raw MRI processing \citep{rempe2026kvit, dou2025mri}. However, the lack of realistic, fully complex synthetic k-space data severely limits data augmentation and the robust validation of next-generation reconstruction algorithms. While recent diffusion approaches \citep{rempe2025phasegen} explore complex-valued generation, their lack of explicit phase topology preservation leaves a critical need for geometrically accurate baselines. Furthermore, while state-of-the-art counterfactual generators provide valuable interpretability in the spatial domain \citep{bedel2024dreamr, min2025instructx2x}, their lack of complex-domain constraints makes them prone to hallucinating non-physical pixel values. Upon Forward Fast Fourier Transform (FFT), these spatial modifications violate topological validity and leak into measured k-space subspaces, creating high-frequency artifacts.
