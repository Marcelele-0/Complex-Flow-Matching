...
\begin{figure}[!t]
    ...
    \begin{subfigure}[t]{0.22\columnwidth}
        ...
        \includegraphics[width=\linewidth]{figures/panels/gt_pair.png}\\[1pt]
        {\tiny \ Mag \hfill Phase \ }
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.38\columnwidth}
        \centering
        {\scriptsize \textbf{(b) Euclidean Flow} ($\mathbb{R}^2$)}\\[1pt]
        \includegraphics[width=\linewidth]{figures/panels/euc_quad.png}\\[1pt]
        {\tiny Mag \ \ $|\Delta\mathrm{M}|$ \hfill Pha \ \ $|\Delta\Phi|$}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.38\columnwidth}
        \centering
        {\scriptsize \textbf{(c) Cylindrical Flow} (Ours)}\\[1pt]
        \includegraphics[width=\linewidth]{figures/panels/cyl_quad.png}\\[1pt]
        {\tiny Mag \ \ $|\Delta\mathrm{M}|$ \hfill Pha \ \ $|\Delta\Phi|$}
    \end{subfigure}
    \caption{\textbf{Qualitative comparison on a representative test slice.} Magnitude and Phase reconstructions alongside corresponding residual error maps ($|\Delta\mathrm{Mag}|$ and $|\Delta\mathrm{Phase}|$). The Euclidean baseline ($\mathbb{R}^2$) exhibits severe phase seam artifacts and boundary magnitude attenuation, which are natively resolved by Cylindrical Flow Matching ($S^1 \times \mathbb{R}^+$).}
