...
\begin{figure}[!t]
    ...
    \begin{tabular}{@{}l@{\hspace{2pt}}c@{\hspace{2pt}}c@{\hspace{10pt}}l@{\hspace{2pt}}c@{\hspace{2pt}}c@{\hspace{5pt}}c@{\hspace{2pt}}c@{\hspace{10pt}}l@{\hspace{2pt}}c@{\hspace{2pt}}c@{\hspace{5pt}}c@{\hspace{2pt}}c@{}}
        ...
        \parbox[t]{1.0cm}{\vspace{0pt}\includegraphics[height=3.2cm]{figures/panels/gt_mag.png}} &
        \parbox[t]{1.0cm}{\vspace{0pt}\includegraphics[height=3.2cm]{figures/panels/gt_pha.png}} &
        ...
        \parbox[t]{1.0cm}{\vspace{0pt}\includegraphics[height=3.2cm]{figures/panels/euc_mag.png}} &
        \parbox[t]{1.0cm}{\vspace{0pt}\includegraphics[height=3.2cm]{figures/panels/euc_pha.png}} &
        \parbox[t]{1.0cm}{\vspace{0pt}\includegraphics[height=3.2cm]{figures/panels/euc_mag_err.png}} &
        \parbox[t]{1.0cm}{\vspace{0pt}\includegraphics[height=3.2cm]{figures/panels/euc_pha_err.png}} &
        ...
        \parbox[t]{1.0cm}{\vspace{0pt}\includegraphics[height=3.2cm]{figures/panels/cyl_mag.png}} &
        \parbox[t]{1.0cm}{\vspace{0pt}\includegraphics[height=3.2cm]{figures/panels/cyl_pha.png}} &
        \parbox[t]{1.0cm}{\vspace{0pt}\includegraphics[height=3.2cm]{figures/panels/cyl_mag_err.png}} &
        \parbox[t]{1.0cm}{\vspace{0pt}\includegraphics[height=3.2cm]{figures/panels/cyl_pha_err.png}}
    \end{tabular}%
    }
    \vspace{1mm}
