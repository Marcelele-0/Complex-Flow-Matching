...
\begin{figure}[!t]
    ...
    \vspace{1mm}
    \caption{\textbf{Qualitative comparison on a representative held-out test slice.} Left to right: Method and slice metrics, Reconstructed Amplitude, Reconstructed Phase, Amplitude Error $|\Delta A|$, and Geodesic Phase Error $|\Delta\theta|$ (Ground Truth shows reference Amplitude and Phase). The Euclidean baseline exhibits severe phase seams and boundary magnitude cancellation, natively avoided by Cylindrical Flow.}
