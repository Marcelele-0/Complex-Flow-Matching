...
\begin{figure}[!t]
    \centering
    \resizebox{\linewidth}{!}{%
    \begin{tabular}{@{}l@{\hspace{4pt}}c@{\hspace{2pt}}c@{\hspace{14pt}}l@{\hspace{4pt}}c@{\hspace{2pt}}c@{\hspace{6pt}}c@{\hspace{2pt}}c@{\hspace{14pt}}l@{\hspace{4pt}}c@{\hspace{2pt}}c@{\hspace{6pt}}c@{\hspace{2pt}}c@{}}
        % Block (a) Ground Truth
        \parbox[c]{2.1cm}{\raggedright \textbf{(a) Ground Truth}\\[2pt]\footnotesize Reference Target\\[-1pt]Full Complex} &
        \includegraphics[height=2.0cm]{figures/panels/gt_mag.png} &
        \includegraphics[height=2.0cm]{figures/panels/gt_pha.png} &
        % Block (b) Euclidean Baseline
        \parbox[c]{2.2cm}{\raggedright \textbf{(b) Euclidean ($\mathbb{R}^2$)}\\[2pt]\footnotesize 25.35 dB\\[-1pt]0.646 SSIM\\[-1pt]0.526 rad} &
        \includegraphics[height=2.0cm]{figures/panels/euc_mag.png} &
        \includegraphics[height=2.0cm]{figures/panels/euc_pha.png} &
        \includegraphics[height=2.0cm]{figures/panels/euc_mag_err.png} &
        \includegraphics[height=2.0cm]{figures/panels/euc_pha_err.png} &
        % Block (c) Cylindrical Flow (Ours)
        \parbox[c]{2.4cm}{\raggedright \textbf{\color{blue!80!black}(c) Cylindrical (Ours)}\\[2pt]\footnotesize \textbf{28.39 dB}\\[-1pt]\textbf{0.762 SSIM}\\[-1pt]\textbf{0.235 rad}} &
        \includegraphics[height=2.0cm]{figures/panels/cyl_mag.png} &
        \includegraphics[height=2.0cm]{figures/panels/cyl_pha.png} &
        \includegraphics[height=2.0cm]{figures/panels/cyl_mag_err.png} &
        \includegraphics[height=2.0cm]{figures/panels/cyl_pha_err.png}
    \end{tabular}%
    }
    \vspace{1mm}
